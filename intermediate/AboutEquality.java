...
public class AboutEquality {
    ...
    public void noObjectShouldBeEqualToNull() {
        assertEquals(new Object().equals(null), false);//new Object() gives you the reference object
    }
    ...
    static class Car {
        ...
        public boolean equals(Object other) {
            if(!(other instanceof Car)){
                ...
                Car car=(Car) other;
                if(car.name==this.name && this.horsepower==car.horsepower){
                    return true;
                }
            }
        ...
        public int hashCode() {
            ...
            return (name+horsepower).hashCode();
        }
    }
