...
public class AboutExceptions {
    ...
    private void tryCatchFinallyWithVoidReturn(StringBuilder whatHappened) {
        try {
            ...
            whatHappened.append(", but so did the finally!; the catch block executed");
        }
    }
    ...
    public void finallyIsAlwaysRan() {
        ...
        assertEquals(whatHappened.toString(), "did something dangerous; the catch block executed, but so did the finally!; the catch block executed");
    }
